...
def create_brake_command(packer, enabled, decel_req, pump, decel_cmd, aeb, idx):
...
def create_accel_command(packer, set_speed, acc_rdy, enabled, is_lead, des_speed, brake_amt, brake_pump):
