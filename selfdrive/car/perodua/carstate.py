...
class CarState(CarStateBase):
  def __init__(self, CP):
    ...
    self.frontDepartureHUD = False
    self.laneDepartureHUD = False
    self.ldpSteerV = 0
    self.aebV = 0
  ...
  def update(self, cp):
    ...
    self.frontDepartureHUD = bool(cp.vl["LKAS_HUD"]["FRONT_DEPART"])
    self.laneDepartureHUD = bool(cp.vl["LKAS_HUD"]["LDA_ALERT"])
